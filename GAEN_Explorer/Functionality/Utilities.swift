...
func nonDecreasing(_ dict:  [Int:Int]) -> [Int:Int]{
    let keys = dict.keys.sorted()
    var value:Int = dict[keys.first!]!
    var result: [Int:Int] = [:]
    for k in keys {
        value = max(value, dict[k]!)
        result[k] = value
    }
    return result
}

func nonIncreasing(_ dict:  [Int:Int]) -> [Int:Int]{
